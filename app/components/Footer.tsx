      ...
      <div className="mx-auto max-w-7xl px-6 py-12 sm:px-10 lg:px-16">
        <div className="grid gap-10 sm:grid-cols-3">
          ...
          <div>
            <a
              href="/#home"
              className="flex items-center gap-2 text-xl font-bold tracking-tight text-text transition-colors hover:text-primary"
            >
              <span className="flex h-9 w-9 items-center justify-center rounded-xl border-2 border-primary text-lg font-bold text-primary">
                G
              </span>
              {profile.name}
            </a>
            <p className="mt-3 text-sm leading-relaxed text-muted">
              {profile.role}. Building scalable web, desktop and mobile

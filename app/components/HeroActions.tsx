...
export default function HeroActions() {
  ...
  return (
    <>
      {/* Buttons */}
      <div className="animate-fade-in-up delay-4 mt-8 flex flex-wrap items-center gap-4">
        <Link
          href="/#projects"
        ...
        >
          ...
          >
            ...
            <path d="m21.75 6.75-9.75 6.75-9.75-6.75" />
          </svg>
          Contact me
        </Link>
      </div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-6 left-1/2 flex -translate-x-1/2 flex-col items-center gap-2 sm:bottom-8">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="none"
        ...
        >
          <rect x="5.5" y="2" width="13" height="20" rx="6.5" />
